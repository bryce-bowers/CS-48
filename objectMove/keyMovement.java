...
public class keyMovement extends JPanel implements ActionListener, KeyListener {
    ...
    */
	...
	/*	
		if(code == KeyEvent.VK_W) { up(); }            // W arrow
		else if(code == KeyEvent.VK_S) { down(); }     // S arrow
		else if(code == KeyEvent.VK_D) { right(); }    // D arrow
		else if(code == KeyEvent.VK_A) { left(); }     // A arrow
	*/
    }
